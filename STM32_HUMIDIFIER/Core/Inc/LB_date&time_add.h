...
#define DATA_LOGGING_CENTER_X 4
#define DATA_LOGGING_CENTER_Y 5
#define PERIOD_CENTER_X DATA_LOGGING_CENTER_X
#define PERIOD_CENTER_Y (DATA_LOGGING_CENTER_Y + 19)
#define LOG_MIN_CENTER_X DATA_LOGGING_CENTER_X
#define LOG_MIN_CENTER_Y (PERIOD_CENTER_Y + 19)
#define LINE_LOG_MINUTES_CENTER_X (DATA_LOGGING_CENTER_X + 24)
#define LINE_LOG_MINUTES_CENTER_Y (DATA_LOGGING_CENTER_Y + 55)
#define LINE_LOG_MINUTES_LENGTH_X 15
#define EOL_LOG_MINUTES_LENGTH_X (LINE_LOG_MINUTES_CENTER_X + LINE_LOG_MINUTES_LENGTH_X)
